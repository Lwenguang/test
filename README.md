...
![image](http://47.102.84.37:6081/api/public/dl/pgieY0B7/pcwxz-1.png)

* 配置如下

![image](http://47.102.84.37:6081/api/public/dl/ocqWokmS/pcwxz-2.png)

* 双击`网易云代理.exe `成功打开网易云说明配置成功了,没反应或提示配置错误请返回上一步检查路径是否错误。
* 下图如果点击 `测试` 提示 该代理不可使用 说明上一步配置错误请检查

![image](http://47.102.84.37:6081/api/public/dl/vKmJAfaV/pcwxz-3.png)
* 点击`确定`后重启网易云音乐即可生效
